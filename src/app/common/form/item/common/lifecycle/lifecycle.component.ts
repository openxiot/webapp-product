...
@Component({
  ...
  styleUrl: './lifecycle.component.less',
  standalone: true,
  imports: [
    NzButtonModule,
    NzInputModule,
  ...
  providers: [
    {
      ...
      useExisting: LifecycleComponent,
      multi: true
    }
  ]
})
export class LifecycleComponent implements ControlValueAccessor {
  ...
  // 组件内部维护的值
  _value: LifeCycle = LifeCycle.DEVELOPMENT;
  ...
  // 选择变化处理
  onRadioChange(value: LifeCycle): void {
  ...
  writeValue(value: LifeCycle): void {
    this._value = value;
  }
