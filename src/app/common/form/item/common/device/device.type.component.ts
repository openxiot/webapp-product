...
@Component({
  ...
  styleUrls: ['./device.type.component.less'],
  standalone: true,
  imports: [
    NzButtonModule,
    NzInputModule,
  ...
  providers: [
    {
      ...
      useExisting: DeviceTypeComponent,
      multi: true
    }
  ]
})
export class DeviceTypeComponent implements ControlValueAccessor {

  @Input() devices: DeviceDefinition[] = [];
  ...
  get selectedLabel(): string {
    const selected = this.devices.find(item => item.type.name === this._value);
