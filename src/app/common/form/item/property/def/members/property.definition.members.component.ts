...
} from '../../../../../dialog/definition/select/member/definition.select.member.component';
import {
  DefinitionSelectMember
} from '../../../../../dialog/definition/select/member/DefinitionSelectMember';
...
export class PropertyDefinitionMembersComponent implements ControlValueAccessor {
  ...
  addMemberItem() {
    const modal = this.modal.create<DefinitionSelectMemberComponent, DefinitionSelectMember, Set<PropertyDefinition>>({
      ...
      nzData: new DefinitionSelectMember(this.properties, this._value, this.language),
      nzFooter: [
        {
          label: '取消',
