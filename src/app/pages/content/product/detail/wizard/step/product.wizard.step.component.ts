...
import {LifeCycle, ProductWizardStep} from '@openxiot/xiot-core-spec-ts';
...
export class ProductWizardStepComponent implements OnInit, OnDestroy {
  ...
  @Output() changed = new EventEmitter<ProductWizardStep>();
